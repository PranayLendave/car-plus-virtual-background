...
def main():
    ...
    parser.add_argument("--output_dir", type=str, required=True, help="Path to the prediction directory")
    ...
    prediction_dir = os.path.join(output_dir, model_name + '_results' + os.sep)
